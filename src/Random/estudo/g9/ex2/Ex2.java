...
public class Ex2 {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("%10s %10d %10d %10d %10d %10d %10d", "Colection", DIM[0], DIM[1], DIM[2], DIM[3], DIM[4], DIM[5]));
        
        double[][] arrayListValues = new double[DIM.length][3];
        double[][] linkedListValues = new double[DIM.length][3];
        ...
        for(int i=0; i<DIM.length; i++){
            ...
            values = checkPerformance(linkedList, DIM[i]);
            linkedListValues[i] = values;
        ...
        printResults(linkedListValues, DIM);
    ...
    public static void printResults(double[][] values, int[] DIM){
        String[] s = {"add", "search", "remove"};

        for(int i=0; i<s.length; i++){
            System.out.print(String.format("%-10s", s[i]));
